...
SECRET_KEY = 'django-insecure-&02i6-1e19-9e1phx^)@b)2sij8qn2j-9k(l!^)ahlizhf21_r'
...
INSTALLED_APPS = [
    ...
    'django.contrib.sessions',  # The session framework stores and retrieves arbitrary data on a per-site-visitor basis.
